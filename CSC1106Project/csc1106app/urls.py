...
urlpatterns = [
    ...
    path('display_chart_information/',login_required(views.display_chart_information), name="display_chart_information"),
    ...
    path('finance/send_sales_email/<int:sales_id>/', views.send_sales_email, name='send_sales_email'),
